...
export const TRANSLATIONS = {
  en: {
    ...
    exercise_finished: 'Completed',
    reopen_exercise: 'Reopen',
    finish_workout: 'Finish Workout',
    finish_workout_title: 'Finish Workout?',
    finish_workout_desc: 'Great session! Are you ready to complete and log this workout?',
    confirm_finish: 'Finish & Save',
    workout_completed_toast: '🎉 Great job! Workout completed and saved.',
    exercise_completed_toast: 'Exercise completed!',
    invalid_set_warning: 'Sets with 0 reps or 0 weight cannot be logged. Please enter values > 0.',
    cannot_finish_exercise_desc: 'Enter valid weight and reps (> 0) to complete this exercise.',
    no_work_done_warning: 'Log at least one valid set before finishing the workout.',
    share_workout: 'Share Workout',
    share_via_whatsapp: 'Send via WhatsApp',
    share_via_apps: 'Share via Apps',
    copy_summary: 'Copy Text',
    copied_to_clipboard: 'Copied to clipboard! Ready to paste in WhatsApp.',
    share_preview: 'Message Preview',
    sets: 'set(s)',
    ...
    exercise_name_placeholder: 'e.g. Bulgarian Split Squat or Treadmill',
    exercise_type: 'Exercise Type',
    type_weight_reps: 'Weight & Reps',
    type_time_based: 'Time / Duration (Cardio, Bodyweight, Plank, etc.)',
    target_muscle_groups: 'Targeted Muscle Groups',
    custom_muscle_placeholder: 'Custom muscle (e.g. Cardio, Core, Brachialis)...',
    ...
    time_mins: 'Minutes',
    set_notes: 'Set Note',
    set_notes_placeholder: 'Optional note (e.g. 20kg vest, 5% incline, 10 km/h)',
  ...
  es: {
    ...
    finish_exercise: 'Terminar Ejercicio',
    exercise_finished: 'Completado',
    reopen_exercise: 'Reabrir',
    finish_workout: 'Finalizar Entrenamiento',
    finish_workout_title: '¿Finalizar Entrenamiento?',
    finish_workout_desc: '¡Excelente sesión! ¿Estás listo para completar y registrar este entrenamiento?',
    confirm_finish: 'Finalizar y Guardar',
    workout_completed_toast: '🎉 ¡Excelente trabajo! Entrenamiento completado y guardado.',
    exercise_completed_toast: '¡Ejercicio completado!',
    invalid_set_warning: 'Las series con 0 repeticiones o 0 peso no se pueden registrar. Ingresa valores mayores a 0.',
    cannot_finish_exercise_desc: 'Ingresa peso y repeticiones válidos (> 0) para terminar este ejercicio.',
    no_work_done_warning: 'Registra al menos una serie válida antes de finalizar el entrenamiento.',
    share_workout: 'Compartir Entrenamiento',
    share_via_whatsapp: 'Enviar por WhatsApp',
    share_via_apps: 'Compartir en Apps',
    copy_summary: 'Copiar Texto',
    copied_to_clipboard: '¡Copiado al portapapeles! Listo para pegar en WhatsApp.',
    share_preview: 'Vista Previa del Mensaje',
    sets: 'serie(s)',
    ...
    exercise_name_placeholder: 'ej. Sentadilla Búlgara o Caminadora',
    exercise_type: 'Tipo de Ejercicio',
    type_weight_reps: 'Peso y Repeticiones',
    type_time_based: 'Por Tiempo / Duración (Cardio, Plancha, etc.)',
    target_muscle_groups: 'Grupos Musculares Objetivo',
    custom_muscle_placeholder: 'Músculo personalizado (ej. Cardio, Core, Braquial)...',
    ...
    seconds: 'seg',
    time_mins: 'Minutos',
    set_notes: 'Nota de la Serie',
    set_notes_placeholder: 'Nota opcional (ej. chaleco 20kg, inclinación 5%, 10 km/h)',
